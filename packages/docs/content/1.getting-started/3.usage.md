...
`zod-mongoose` is optimized for Nuxt 4. Import shared schema helpers from `@nullix/zod-mongoose`; Nuxt then selects the browser-safe client entry or the Nitro server entry automatically.
