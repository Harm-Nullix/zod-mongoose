...
- **Isomorphic Support**: Use the same schemas on the frontend and backend with automatic environment detection.
- **Nuxt 4 Ready**: Use core helpers in Nuxt and Nitro; conditional exports select the browser-safe client implementation automatically.
