...
|-------------|----------------------------------|---------------------------------------------|------------------------------------------------------------------------------------------------------|
| v3.1  🏗️    | Minor (Deprecations & Additions) | Introduce @nullix/zod-mongoose/nuxt subpath | Existing code remains 100% functional. Developers get clear deprecation notices and time to migrate. |
